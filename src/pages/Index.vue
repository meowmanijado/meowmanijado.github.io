    ...
    <main class="max-w-screen-lg mx-auto">
        <div class="flex items-center flex-col-reverse lg:flex-row md:flex-row lg:mx-0 mx-10">
          <div class="lg:w-3/5 md:w-3/5 w-full">
            ...
            <p>Programmer based from Manila. I love building solutions and  
            ...
            <p>Former Senior Developer at Traxion Tech. Inc. and Frontend Web Engineer at Wishland Software Technology Inc. </p>
          </div>
        </div>
    </main>
  </Layout>
