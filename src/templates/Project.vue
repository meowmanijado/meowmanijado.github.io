<template>
  <Layout>
    <main>
      <header>
        <div class="max-w-xl md:max-w-3xl xl:max-w-4xl flex flex-col-reverse mx-auto text-center px-6 pt-24 mb-10">
          <p class="leading-tight text-gray-700 text-sm">{{ $page.tag.belongsTo.totalCount }} posts in total</p>
          <h1 class="my-4 text-center tracking-widest uppercase">{{ titleCase($page.tag.title) }}</h1>
